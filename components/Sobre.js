  ...
  return (
    <View style={Styles.container}>
      <Text style={Styles.texto}>Bem vindo a calculadora de notas do IFRN</Text>
            ...
            <Text style={Styles.texto}>Caso esteja no ensino medio ou tecnico, possuindo 4 notas, a duas primeiras notas tem peso 2 e as duas ultimas peso 3. Com a soma das notas depois do calculo do peso, é dividido pelo peso total, que no caso seria a soma de todos os pesos, resultando em 10, ou seja:
      </Text>
